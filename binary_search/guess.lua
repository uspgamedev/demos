...
function state.draw ()
  ...
  graphics.printf(P, W/8 - 16, 64 + 16, 32, 'center')
  graphics.point(7*W/8, 64)
  graphics.printf(Q, 7*W/8 - 16, 64 + 16, 32, 'center')
  graphics.setColor(200, 0, 0, 255)
  graphics.point(W/8 + (6*W/8)*(current/(Q - P)), 64)
  -- Tries counter
  graphics.setColor(200, 200, 0, 255)
  graphics.setFont(smallfont)
  graphics.print("Number of tries: "..tries, W/8, H/4)
  -- Big number
  graphics.setColor(255, 255, 255, 255)
